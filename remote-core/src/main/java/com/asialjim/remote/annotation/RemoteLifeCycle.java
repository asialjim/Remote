 ...
 * <pre>
 * Remote 生命周期
 * 用于标注该注解为一个流程处理生命周期注解
 * 一般注解被此注解标注，表示被此注解标注的注解在流程处理中的某个或者多个流程中具有对应的职责
 *
 * Remote Lifecycle
 * Used to annotate this annotation as a lifecycle annotation for workflow processing.
 * Generally, an annotation marked with this annotation indicates the corresponding responsibilities within one or multiple workflows in the process.
 * </pre>
 *
