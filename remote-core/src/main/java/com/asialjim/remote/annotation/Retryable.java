...
import com.asialjim.remote.context.*;
...
/**
 * <pre>
 * 可重复执行的,用于标记某客户端重复可以重复执行，用户可能需要指定重试策略
 * {@link com.asialjim.remote.lifecycle.callback.RetryWhen}, {@link com.asialjim.remote.lifecycle.callback.OnRetry}
 *
 * "Repeatable Execution" is used to mark a client as capable of being repeatedly executed. Users might need to specify a retry strategy using
 * {@link com.asialjim.remote.lifecycle.callback.RetryWhen} and {@link com.asialjim.remote.lifecycle.callback.OnRetry}.
 * </pre>
 *
