...
/**
 * <pre>
 * Remote 本地环境, 一般情况下，适用于本地存在多种系统环境，但多种环境又公用同一数据源的情况。
 *
 * "Remote Local Environment" is generally applicable when there are multiple local systems sharing a common data source. This scenario arises when there are various local environments coexisting but utilizing the same data source.
 * </pre>
 *
