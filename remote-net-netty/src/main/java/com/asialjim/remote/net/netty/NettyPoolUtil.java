...
import static com.asialjim.remote.net.netty.context.RemoteNettyChannelContext.CURRENT_REQ_BOUND_WITH_THE_CHANNEL;
        ...
        try {
            ...
            if (arg instanceof ReferenceCounted) {
                ...
                if (counted instanceof ByteBufHolder) {
                    ByteBufHolder holder = (ByteBufHolder) counted;
