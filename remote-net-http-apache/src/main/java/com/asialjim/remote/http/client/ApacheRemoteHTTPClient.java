...
import com.asialjim.remote.http.annotation.HttpMethod;
...
import static com.asialjim.remote.http.annotation.lifecycle.AbstractHttpHeaderLifeCycle.HTTP_HEADER_VALUE;
import static com.asialjim.remote.http.annotation.lifecycle.BaseObjectMapperRequestBodyLifeCycle.STRING_BODY_KEY;

/**
 * 给予 Apache 的 HTTP 请求客户端
 *
...
public class ApacheRemoteHTTPClient implements RemoteNetClient {
    ...
    public static void addOctetStreamEntity(RemoteReqContext req) {
        ...
        String contentType = Optional.ofNullable(header).map(Map::entrySet)
